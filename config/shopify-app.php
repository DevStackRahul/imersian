...
return [
    ...
    */
    ...
    'webhooks' => [
            ...
            [   
                'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'THEMES_PUBLISH'),
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://app.imersian.com/public/webhook/theme-publish')
            ],

            [
                'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'APP_UNINSTALLED'),
                'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://app.imersian.com/public/webhook/app-uninstalled')
            ],

            // [
            //     'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'SHOP_REDACT'),
            //     'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://shopify.imersian.com/public/webhook/shop-redact')
            // ],
            
            // [
            //     'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'APP_UNINSTALLED'),
            //     'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://shopify.imersian.com/public/webhook/app-uninstalled')
            // ],
